...
//    private Bitmap bitmap2;
    ...
    public GesturePassWordView(Context context, @Nullable AttributeSet attrs) {
        ...
        normalCircleColor = a.getResourceId(R.styleable.GesturePassWordView_normalCircleColor, getResources().getColor(R.color.del_btn_disabled_));
        pressedCircleColor = a.getResourceId(R.styleable.GesturePassWordView_pressedCircleColor, getResources().getColor(R.color.toolbar_));
        errorCircleColor = a.getResourceId(R.styleable.GesturePassWordView_errorCircleColor, Color.RED);
        linePressedColor = a.getResourceId(R.styleable.GesturePassWordView_pressedLineCircleColor, getResources().getColor(R.color.toolbar_));
        lineErrorColor = a.getResourceId(R.styleable.GesturePassWordView_errorLineCircleColor, Color.RED);
        outSideErrorCircleColor = a.getResourceId(R.styleable.GesturePassWordView_outSideErrorCircleColor, getResources().getColor(R.color.del_btn_disabled_));
        outSidePressedCircleColor = a.getResourceId(R.styleable.GesturePassWordView_outSidePressedCircleColor, getResources().getColor(R.color.del_btn_disabled_));
        ...
        outSideNormalCircleColor = a.getResourceId(R.styleable.GesturePassWordView_outSideNormalCircleColor, getResources().getColor(R.color.del_btn_disabled_));
